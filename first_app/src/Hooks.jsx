...
import React, {useEffect, useState, useReducer, useRef, useLayoutEffect,
  useImperativeHandle, forwardRef, createContext, useMemo, useCallback} from 'react';
...
const Hooks=()=>{
  ...
  return <div>
    ...
    <div>
      ...
      <h1>From whose click</h1>
      <button onClick={()=>{
        childBtnRef.current.alterToggle();
      }}>Parent Btn</button>
